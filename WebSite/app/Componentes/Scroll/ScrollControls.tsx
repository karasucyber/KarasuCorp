...
const ScrollCanvas = React.forwardRef<THREE.Group, { children: React.ReactNode }>(
  ({ children }, ref) => {
...
const ScrollHtml = React.forwardRef<HTMLDivElement, { children: React.ReactNode; style?: React.CSSProperties }>(
...
export const Scroll = React.forwardRef(({ html, ...props }: ScrollProps, ref:any) => {
